...
const narakaDetails = {
  ...
  20: {
    ...
    avoidance: {
      ...
      hi: [
        "नशा करने की आदत से बचें",
        "पलायन के बजाय जागरूकता को चुनें",
        "नशा मन को नियंत्रित न करने दें",
        "अपने शरीर को पवित्र समझें",
        "साफ मन से आध्यात्मिकता प्राप्त करें"
      ],
      ne: [
        "लत लाग्ने नशाको सेवनबाट बच्नुस्",
        "पलायन होइन, जागरूकता रोज्नुस्",
        "नशाले दिमाग नियन्त्रण गर्न नदिनुहोस्",
        "शरीरलाई पवित्र मन्दिर ठान्नुस्",
        "साफ चेतनाले आध्यात्मिक मार्ग रोज्नुस्"
      ],
      sa: [
        "मद्यानां सेवनं अधिकं न कुर्यात्",
        "ज्ञानमार्गं पलायनात् वरेण्यम्",
        "द्रव्यैः मनसः अधीनता न स्वीकुर्यात्",
        "शरीरं पावनं गृहं इव मन्येत",
        "निर्मलचेतसा आत्मबोधं साधयेत"
      ]
    },
    quote: {
  ...
  22: {
    ...
    category: "Corruption, Deception",
    severity: "severe",
    sin: {
      en: "Corrupt judgment and deceit in positions of power",
      hi: "सत्ता में रहते हुए भ्रष्ट निर्णय और धोखाधड़ी",
      ne: "सत्ताको दुरुपयोग र निर्णयमा भ्रस्टता",
      sa: "सत्तास्थानेषु दुरविवेकं च कपटं च",
    },
    punishment: {
      en: "Dragged through a swamp of acidic filth",
      hi: "तेज़ाब जैसे कीचड़ में घसीटा जाता है",
      ne: "अम्लीय फोहोरको दलदलमा तानिन्छ",
      sa: "तीव्रक्षारेण कीचके घर्षणं",
    },
    detailedSin: {
      en: "Leaders, officials, or judges who misuse authority for personal gain, spreading suffering through lies and bias.",
      hi: "नेता, अधिकारी या न्यायाधीश जो अपने लाभ के लिए सत्ता का दुरुपयोग करते हैं और झूठ व पक्षपात से लोगों को पीड़ा देते हैं।",
      ne: "नेता, अधिकारी वा न्यायाधीश जसले व्यक्तिगत स्वार्थका लागि पदको दुरुपयोग गर्छन् र झूट बोल्छन्।",
      sa: "ये अधिपाः स्वलाभाय सत्तां दुरुपयुञ्जते, मिथ्यावचनेन पीडां वितरन्ति।",
    },
    moralLesson: {
      en: "Power is a responsibility, not a privilege to exploit.",
      hi: "सत्ता एक जिम्मेदारी है, न कि शोषण का अधिकार।",
      ne: "सत्ता जिम्मेवारी हो, शोषणको अधिकार होइन।",
      sa: "सत्ता न हि लाभाय किन्तु धर्मपरायणाय।",
    },
    avoidance: {
      en: [
        "Use authority with integrity",
        "Always be accountable for decisions",
        "Uphold justice over personal gain",
        "Resist corruption even under pressure",
        "Value truth in all official matters"
      ],
      hi: [
        "सत्ता का उपयोग ईमानदारी से करें",
        "हर निर्णय की ज़िम्मेदारी लें",
        "न्याय को लाभ से ऊपर रखें",
        "दबाव में भी भ्रष्टाचार से बचें",
        "सार्वजनिक मामलों में सत्य का पालन करें"
      ],
      ne: [
        "सत्ताको प्रयोग ईमानदार बनाउनुहोस्",
        "निर्णयको उत्तरदायित्व लिनुहोस्",
        "व्यक्तिगत लाभभन्दा न्यायलाई प्राथमिकता दिनुहोस्",
        "दबाबमा पनि भ्रस्टाचारबाट टाढा रहनुहोस्",
        "सार्वजनिक मामिलामा साँचोको कदर गर्नुहोस्"
      ],
      sa: [
        "सत्तां धर्मेण योजयेत्",
        "स्वनिर्णयानां दायित्वं स्वीकरोतु",
        "धर्मं न्यायं च लाभात् अधिकं मन्येत",
        "कठिनावस्थायामपि दुराचारं वर्जयेत्",
        "सार्वजनिकवृत्तान्तेषु सत्यं यथावत् वदेत्"
      ]
    },
    quote: {
      en: "In the swamp of lies, only truth can cleanse the soul.",
      hi: "झूठ के दलदल में केवल सत्य ही आत्मा को शुद्ध करता है।",
      ne: "झूटको दलदलमा आत्मा शुद्ध गर्ने एकमात्र सत्य हो।",
      sa: "कपटकीचके आत्मशौचं केवलं सत्येन सम्भवम्।"
    }
  },
